...
namespace d3d
{
	...
	used to render a series of DrawPrimitivesTask objects. Given a list of
	RenderPrimitivesTask objects, generates the necessary transitional
	RenderTask objects in order to correctly render the DrawPrimitivesTask
	objects.
	*/
	...
	public:
		...
		correctly render the DrawPrimitiveTask objects specified when
		executed.
		...
		*/
		...
		/** Executes the sequence of RenderTask objects on the context of
		\a render_context.
	...
	private:
		...
		*/
		...
		std::vector<std::auto_ptr<RenderTask>> render_tasks;
