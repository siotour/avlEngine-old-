...
/**
@file
Implementation for the set texture task component. See "set texture task.h" for details.
@author Sheldon Bachstein
@date Aug 01, 2012
*/

#include"set texture task.h"
...
namespace d3d
{
	...
	SetTextureTask::SetTextureTask(IDirect3DTexture9& initial_texture)
		: texture(initial_texture)
	{
	}

	// See method declaration for details.
	SetTextureTask::SetTextureTask(SetTextureTask& original)
