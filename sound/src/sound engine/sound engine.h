...
#include"..\..\..\utility\src\sound sample\sound sample.h"
...
namespace sound
{
	...
	*/
	...
	public:
		...
		*/
		virtual const utility::SoundEffect::SoundHandle AddSoundSample(const utility::SoundSample& new_sample) = 0;
		...
		*/
		virtual void DeleteSoundSample(const utility::SoundEffect::SoundHandle& handle) = 0;

		/** Updates the states of the sound effects in \a sounds. Details may
		vary between different implementations.
		@param sounds The SoundEffect objects whose state needs to be updated.
		*/
		virtual void UpdateSounds(const utility::SoundEffectList& sounds) = 0;
