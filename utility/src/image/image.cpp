...
namespace utility
{
	...
	Image::Image(const unsigned int& initial_width, const unsigned int& initial_height,
			const unsigned short& initial_pixel_depth, const bool& initial_alpha, unsigned char* initial_pixel_data)
		: width(initial_width), height(initial_height), pixel_depth(initial_pixel_depth), contains_alpha_channel(initial_alpha), pixel_data(initial_pixel_data)
	{
